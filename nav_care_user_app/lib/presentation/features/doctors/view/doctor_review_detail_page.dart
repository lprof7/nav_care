...
class DoctorReviewDetailPage extends StatelessWidget {
  final DoctorReviewModel review;

  const DoctorReviewDetailPage({super.key, required this.review});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('doctors.review_detail.title'.tr()),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'doctors.review_detail.comment_title'.tr(),
              style: theme.textTheme.titleMedium?.copyWith(
                fontWeight: FontWeight.w700,
              ),
            ),
