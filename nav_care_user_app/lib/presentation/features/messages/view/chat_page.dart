...
import 'package:nav_care_user_app/presentation/features/messages/viewmodel/chat_messages_cubit.dart';
import 'package:nav_care_user_app/presentation/features/messages/viewmodel/chat_messages_state.dart';
      ...
      create: (_) {
        ...
        if (trimmedConversationId != null &&
          ...
          cubit.load(
            ...
            currentUserId: context.read<AuthSessionCubit>().state.user?.id,
...
class _ChatViewState extends State<_ChatView> {
  ...
  Widget build(BuildContext context) {
    ...
    final userId = context.read<AuthSessionCubit>().state.user?.id ?? '';
