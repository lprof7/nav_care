...
import 'package:nav_care_offers_app/data/reviews/hospital_reviews/hospital_reviews_remote_service.dart';
...
class HospitalReviewsRepository {
  ...
  Future<ReviewsPage<HospitalReviewModel>> getHospitalReviews({
    ...
    final reviews = _mapList(listSource)
        .map(HospitalReviewModel.fromJson)
